...
class KeyLocation {
  ...
  static const STANDARD = KeyLocation._(0);

  /// The event key is in the left key location.
  static const LEFT = KeyLocation._(1);

  /// The event key is in the right key location.
  static const RIGHT = KeyLocation._(2);

  /// The event key originated on the numeric keypad or with a virtual key
  /// corresponding to the numeric keypad.
  static const NUM_PAD = KeyLocation._(3);
  ...
  static const D_PAD = KeyLocation._(4);
}
